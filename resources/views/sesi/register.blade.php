...
@section('container')
    ...
    <body class="text-center">
        ...
        <main class="form-signin w-100 m-auto">
            <form method="POST" action="/sesi/create">
                @csrf
                <h1 class="h3 mb-3 fw-normal text-light text-center">Sign Up</h1>
                ...
                <button class="w-100 btn btn-lg btn-success" name="submit" type="submit">Sign Up</button>
                <div class="mt-3 text-center text-light">
                    <p>Already have an account? <a href="/login/all">Sig In</a></p>
                </div>
